    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <?php
                ...
                echo "Resultado: ";
                echo ($a + 3) * 4 + (5 * $b);
                echo "<br>Porque " . '$a' . " Vale 2";
                echo 'e $b vale 4 <br>';
                echo "Primeiro se calcula 2 ". '(ou seja, $a)' . " + 3 == 5 <br>";
                echo 'Segundo multiplica 5 * 4 (ou seja, $b) == 20 <br>';
                echo "Terceiro multiplica 5 * 4 == 20 <br>";
                echo "Por fim some 20 + 20 == 40"
